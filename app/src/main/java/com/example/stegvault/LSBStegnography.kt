...
class LSBStegnography : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lsbstegnography)

        // Handle window insets for edge-to-edge content if needed
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.lsbStegActivity)) { view, insets ->
        ...
        viewPager.adapter = LsbPagerAdapter(this)
